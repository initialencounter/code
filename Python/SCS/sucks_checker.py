...
class TestProblem(unittest.TestCase):
    ...
    def test_loopy_madness(self):
        self.assertEqual(lab6.loopy_madness('a', 'c'), 'ac')
        self.assertEqual(lab6.loopy_madness('ac', 'bd'), 'abcd')
        self.assertEqual(lab6.loopy_madness('ab', 'c'), 'acbc')
        self.assertEqual(lab6.loopy_madness('c', 'ab'), 'cacb')
        self.assertEqual(lab6.loopy_madness('c', 'abbbbbbbbbbbbbbbbbbbbb' + 'b' * 10000), 'cacbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcb' + 'cb' * 10000)
        self.assertEqual(lab6.loopy_madness('abbbbbbbbbbbbbbbbbbbbb' + 'b' * 10000, 'c'), 'acbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbcbc' + 'bc' * 10000)
        self.assertEqual(lab6.loopy_madness('abcd', 'ef'), 'aebfcedf')
        self.assertEqual(lab6.loopy_madness('abcd', 'efg'), 'aebfcgdf')
        self.assertEqual(lab6.loopy_madness('abcdfe', '123'), 'a1b2c3d2f1e2')
